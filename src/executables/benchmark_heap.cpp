...
void RegisterHeapBenchmarks()
{
    ...
    {
        SetHeapRange(SKA_BENCHMARK_CATEGORIES(&benchmark_min_element, builder.BuildCategories("min_element", "min_element"))->SetBaseline("benchmark_heap_baseline"));
        SetHeapRange(SKA_BENCHMARK_CATEGORIES(&benchmark_min_element_four, builder.BuildCategories("min_element", "min_element_four"))->SetBaseline("benchmark_heap_baseline"));
        SetHeapRange(SKA_BENCHMARK_CATEGORIES(&benchmark_min_element_branchy, builder.BuildCategories("min_element", "min_element_branchy"))->SetBaseline("benchmark_heap_baseline"));
        SetHeapRange(SKA_BENCHMARK_CATEGORIES(&benchmark_min_element_parallel, builder.BuildCategories("min_element", "min_element_parallel"))->SetBaseline("benchmark_heap_baseline"));
    }
}
