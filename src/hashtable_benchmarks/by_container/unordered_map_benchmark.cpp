...
void RegisterUnorderedMap()
{
    ...
    skb::CategoryBuilder ska_unordered_map = prime.AddCategory("unordered_map variant", "ska::unordered_map");
    skb::CategoryBuilder ska_unordered_map_power_of_two = power_of_two.AddCategory("unordered_map variant", "ska::unordered_map");
    skb::CategoryBuilder ska_unordered_map_libdivide = libdivide.AddCategory("unordered_map variant", "ska::unordered_map");
    skb::CategoryBuilder ska_unordered_map_switch_prime = switch_prime.AddCategory("unordered_map variant", "ska::unordered_map");
