#include "google_flat16_hash_map.hpp"

static_assert(std::is_nothrow_move_constructible<ska::google_flat16_hash_map<int, int> >::value, "expect it to be nothrow movable");
static_assert(std::is_nothrow_move_assignable<ska::google_flat16_hash_map<int, int> >::value, "expect it to be nothrow movable");
...
{
    ska::google_flat16_hash_map<int, int> a;
...
TEST(sherwood_v12, initializer_list)
{
    ska::google_flat16_hash_map<int, int> a = { { 1, 3 }, { 2, 4 }, { 3, 5 }, { 4, 6 } };
...
TEST(sherwood_v12, empty_access)
{
    ska::google_flat16_hash_map<int, int> a;
    ASSERT_EQ(0, a[0]);
}

TEST(sherwood_v12, conflicts)
{
    ska::google_flat16_hash_map<int, int> a = { { 1, 3 }, { 6, 4 }, { 11, 5 }, { 16, 6 }, { 21, 7 } };
    ASSERT_EQ(a.end(), a.find(0));
    ASSERT_NE(a.end(), a.find(1));
    ASSERT_EQ(3, a[1]);
...
TEST(sherwood_v12, displace_element)
{
    ska::google_flat16_hash_map<int, int> a = { { 1, 3 }, { 2, 5 }, { 6, 4 }, { 11, 5 }, { 16, 6 }, { 21, 7 } };
    ASSERT_EQ(a.end(), a.find(0));
    ASSERT_NE(a.end(), a.find(1));
    ASSERT_EQ(3, a[1]);
    ASSERT_NE(a.end(), a.find(2));
...
TEST(sherwood_v12, displace_twice)
{
    ska::google_flat16_hash_map<int, int> a = { { 1, 3 }, { 2, 5 }, { 0, 4 }, { 5, 5 }, { 10, 6 } };
...
TEST(sherwood_v12, erase_conflicting)
{
    ska::google_flat16_hash_map<int, int> a;
...
TEST(sherwood_v12, erase_distance_to_element)
{
    ska::google_flat16_hash_map<int, int> a;
    a.max_load_factor(1.0f);
    a.rehash(47);
...
TEST(sherwood_v12, erase_and_reinsert)
{
    ska::google_flat16_hash_map<int, int> a;
    a.max_load_factor(1.0f);
    a.rehash(47);
...
template<typename T>
struct sherwood_test_v12 : ::testing::Test
{
};

TYPED_TEST_CASE_P(sherwood_test_v12);

TYPED_TEST_P(sherwood_test_v12, empty)
{
...
TYPED_TEST_P(sherwood_test_v12, simple)
{
...
TYPED_TEST_P(sherwood_test_v12, conflicting_insert)
{
    typedef typename TypeParam::template map<int, int> map_type;
    map_type a;
    a.reserve(5);
...
TYPED_TEST_P(sherwood_test_v12, full_map_one_bucket)
{
    typedef typename TypeParam::template map<int, int> map_type;
    map_type a;
    a.reserve(2);
...
TYPED_TEST_P(sherwood_test_v12, move_construct)
{
...
TYPED_TEST_P(sherwood_test_v12, copy)
{
    typedef typename TypeParam::template map<int, int> map_type;
...
TYPED_TEST_P(sherwood_test_v12, erase)
{
    typedef typename TypeParam::template map<int, int> map_type;
    map_type a = { { 1, 2 }, { 3, 4 } };
    ASSERT_EQ(2u, a.size());
...
TYPED_TEST_P(sherwood_test_v12, iterator_erase)
{
    typedef typename TypeParam::template map<int, int> map_type;
...
TYPED_TEST_P(sherwood_test_v12, two_element_conflicting_iterator_erase)
{
...
TYPED_TEST_P(sherwood_test_v12, two_bucket_conflicting_iterator_erase)
{
    typedef typename TypeParam::template map<int, int, IdentityHasher> map_type;
    map_type a;
    size_t count = 5;
...
TYPED_TEST_P(sherwood_test_v12, range_erase)
{
    typedef typename TypeParam::template map<int, int> map_type;
...
TYPED_TEST_P(sherwood_test_v12, erase_all)
{
    typedef typename TypeParam::template map<int, int> map_type;
    map_type a;
    a.rehash(3);
...
TYPED_TEST_P(sherwood_test_v12, move_over_please)
{
    typedef typename TypeParam::template map<int, int, IdentityHasher> map_type;
    map_type a;
    a.max_load_factor(1.0f);
...
TYPED_TEST_P(sherwood_test_v12, move_over_distance)
{
    typedef typename TypeParam::template map<int, int, IdentityHasher> map_type;
    map_type a;
    a.max_load_factor(1.0f);
...
TYPED_TEST_P(sherwood_test_v12, many_collisions)
{
    typedef typename TypeParam::template map<int, int, IdentityHasher> map_type;
    map_type a;
    a.max_load_factor(1.0f);
...
TYPED_TEST_P(sherwood_test_v12, more_collision_insert)
{
    typedef typename TypeParam::template map<int, int, IdentityHasher> map_type;
    map_type a;
    a.max_load_factor(1.0f);
...
TYPED_TEST_P(sherwood_test_v12, emplace_hint)
{
    typedef typename TypeParam::template map<int, int> map_type;
    map_type a = { { 1, 2 }, { 3, 4 } };
    auto found = a.find(1);
...
TYPED_TEST_P(sherwood_test_v12, swap)
{
    typedef typename TypeParam::template map<int, int> map_type;
...
TYPED_TEST_P(sherwood_test_v12, destructor_caller)
{
...
TYPED_TEST_P(sherwood_test_v12, stateful_hasher_test)
{
...
TYPED_TEST_P(sherwood_test_v12, load_factor)
{
    typename TypeParam::template map<int, int> a;
    ASSERT_EQ(0, a.load_factor());
}
TYPED_TEST_P(sherwood_test_v12, dont_grow_when_you_wont_insert)
{
    typename TypeParam::template map<int, int> a;
    a.reserve(3);
...
TYPED_TEST_P(sherwood_test_v12, allow_growing_with_max_load_factor_1)
{
    typedef typename TypeParam::template map<int, int, IdentityHasher> map_type;
    map_type a;
    a.max_load_factor(1.0f);
...
TYPED_TEST_P(sherwood_test_v12, max_load_factor)
{
    typedef typename TypeParam::template map<int, int, IdentityHasher> map_type;
    map_type a;
...
TYPED_TEST_P(sherwood_test_v12, map_of_pairs)
{
...
REGISTER_TYPED_TEST_CASE_P(sherwood_test_v12, empty, simple, move_construct, copy,
...
template<typename T>
struct sherwood_set_test_v12 : ::testing::Test
{
};

TYPED_TEST_CASE_P(sherwood_set_test_v12);

TYPED_TEST_P(sherwood_set_test_v12, simple)
{
...
TYPED_TEST_P(sherwood_set_test_v12, force_reallocate)
{
...
TYPED_TEST_P(sherwood_set_test_v12, force_reallocate_dont_overflow_30)
{
    typedef typename TypeParam::template set<size_t> set_type;
    set_type a;
    std::set<size_t> as_set;
...
TYPED_TEST_P(sherwood_set_test_v12, force_reallocate_on_last)
{
    typedef typename TypeParam::template set<size_t> set_type;
    set_type a;
    std::set<size_t> as_set;
...
TYPED_TEST_P(sherwood_set_test_v12, set_of_pairs)
{
...
REGISTER_TYPED_TEST_CASE_P(sherwood_set_test_v12,
                           simple, force_reallocate, force_reallocate_dont_overflow_30, force_reallocate_on_last,
                           set_of_pairs);

struct sherwood_v12_tester
{
    template<typename K, typename V, typename H = std::hash<K>, typename E = std::equal_to<K>, typename A = std::allocator<std::pair<K, V> > >
    using map = ska::google_flat16_hash_map<K, V, H, E, A>;
    template<typename T, typename H = std::hash<T>, typename E = std::equal_to<T>, typename A = std::allocator<T> >
    using set = ska::google_flat16_hash_set<T, H, E, A>;
};

struct sherwood_v12_tester_power_of_two
{
...
INSTANTIATE_TYPED_TEST_CASE_P(sherwood_v12, sherwood_test_v12, sherwood_v12_tester);
INSTANTIATE_TYPED_TEST_CASE_P(sherwood_v12, sherwood_set_test_v12, sherwood_v12_tester);

INSTANTIATE_TYPED_TEST_CASE_P(sherwood_v12_power_of_two, sherwood_test_v12, sherwood_v12_tester_power_of_two);
INSTANTIATE_TYPED_TEST_CASE_P(sherwood_v12_power_of_two, sherwood_set_test_v12, sherwood_v12_tester_power_of_two);
