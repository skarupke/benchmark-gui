...
namespace detail_linear_search
{
...
struct inplace_linear_search_map
{
private:
    using vec_type = small_vector<std::pair<K, V>, 1024, A>;
public:
    ...
    {
        detail_linear_search::KeyOrValueEquality<K, std::pair<K, V>, std::equal_to<K>> compare;
    ...
    {
        return const_cast<inplace_linear_search_map &>(*this).find(key);
    }
