...
private:
    ...
    int8_t hit_max_lookups_limit = 0;
    ...
    bool hit_max_lookups(int8_t distance_from_desired)
    {
...
template<typename T, typename H = std::hash<T>, typename E = std::equal_to<T>, typename A = std::allocator<T>, detailv3::FlatHashMapLookupType lookup_type = detailv3::SimpleLookup >
class flat_hash_set
        : public detailv3::sherwood_v3_table
        <
            T,
