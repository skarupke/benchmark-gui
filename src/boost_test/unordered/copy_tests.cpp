...
static test::seed_t initialize_seed(9063);
...
UNORDERED_TEST(copy_construct_tests1, (
        ...
        (test_set_select_copy)/*(test_multiset_select_copy)(test_map_select_copy)*/(test_flat_map_select_copy)/*(test_multimap_select_copy)*/
        (test_set_no_select_copy)/*(test_multiset_no_select_copy)(test_map_no_select_copy)*/(test_flat_map_no_select_copy)/*(test_multimap_no_select_copy)*/
    )
