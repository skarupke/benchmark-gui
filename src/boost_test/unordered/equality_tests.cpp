...
#define UNORDERED_EQUALITY_SET_TEST(seq1, op, seq2)                         \
    {                                                                       \
        boost_test_hash_set<int, mod_compare, mod_compare> set1, set2;     \
...
#define UNORDERED_EQUALITY_MAP_TEST(seq1, op, seq2)                         \
    ...
    /*}*/\
{                                                                      \
    boost_test_hash_map1<int, int, mod_compare, mod_compare>            \
		map1, map2;                                                     \
	BOOST_PP_SEQ_FOR_EACH(UNORDERED_MAP_INSERT, map1, seq1)             \
	BOOST_PP_SEQ_FOR_EACH(UNORDERED_MAP_INSERT, map2, seq2)             \
	BOOST_TEST(map1 op map2);                                           \
...
#define UNORDERED_MAP_INSERT(r, map, item) \
    ...
    {
        // the mod_compare says that the two should be equal
        UNORDERED_EQUALITY_SET_TEST(
            (1), ==, (1001))
        UNORDERED_EQUALITY_MAP_TEST(
            ((1)(2))((1002)(1)), !=, ((1002)(2))((1)(1)))
    }
    ...
    {
        typedef boost_test_hash_set<int, mod_compare, mod_compare> set;
