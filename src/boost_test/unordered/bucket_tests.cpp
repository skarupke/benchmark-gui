...
static test::seed_t initialize_seed(54635);
...
void tests(X*, test::random_generator generator)
{
    ...
    {
		size_t bucket = x.bucket(test::get_key<X>(*it));
...
boost_test_hash_map2<test::object, test::object,
	test::hash, test::equal_to,
...
UNORDERED_TEST(tests,
    (/*(test_multimap_std_alloc)(test_multiset)*/(test_set)(test_map)(test_flat_map)/*(test_multimap)*/)
