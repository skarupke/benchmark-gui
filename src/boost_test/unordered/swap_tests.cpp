...
static test::seed_t initialize_seed(783472);
...
UNORDERED_TEST(swap_tests1, (
        /*(test_map_std_alloc)*/(test_flat_map_std_alloc)
        (test_set)/*(test_multiset)(test_map)*/(test_flat_map)/*(test_multimap)*/
        (test_set_prop_swap)/*(test_multiset_prop_swap)(test_map_prop_swap)*/(test_flat_map_prop_swap)/*(test_multimap_prop_swap)*/
        (test_set_no_prop_swap)/*(test_multiset_no_prop_swap)(test_map_no_prop_swap)*/(test_flat_map_no_prop_swap)/*(test_multimap_no_prop_swap)*/
    )
