...
{
	static test::seed_t initialize_seed(98624);
...
#define BOOST_UNORDERED_TEST_MOVING 0
    ...
    void move_assign_tests2(T*, test::random_generator const& generator)
    {
...

        {
            ...
            test::object_count count;
			y = create(v2, count, hf, eq, al2, 1.0);
            BOOST_TEST(y.empty());
    ...
    boost_test_hash_map1<test::object, test::object,
		test::hash, test::equal_to,
        std::allocator<test::object> >* test_flat_map_std_alloc;
    ...
    boost_test_hash_map1<test::object, test::object,
		test::hash, test::equal_to,
        test::allocator1<test::object> >* test_flat_map;
...
boost::unordered_multimap<test::object, test::object,
    ...
    UNORDERED_TEST(move_construct_tests1, (
            /*(test_map_std_alloc)*/
            /*(test_set)(test_multiset)(test_map)*/(test_flat_map)/*(test_multimap)*/
            /*(test_set_prop_move)(test_multiset_prop_move)(test_map_prop_move)*/(test_flat_map_prop_move)/*(test_multimap_prop_move)*/
            /*(test_set_no_prop_move)(test_multiset_no_prop_move)(test_map_no_prop_move)*/(test_flat_map_no_prop_move)/*(test_multimap_no_prop_move)*/
        )
    ...
    UNORDERED_TEST(move_construct_tests2, (
            (test_set)/*(test_multiset)*/(test_flat_map)/*(test_map)(test_multimap)*/
            (test_set_prop_move)/*(test_multiset_prop_move)(test_map_prop_move)*/(test_flat_map_prop_move)/*(test_multimap_prop_move)*/
            (test_set_no_prop_move)/*(test_multiset_no_prop_move)(test_map_no_prop_move)*/(test_flat_map_no_prop_move)/*(test_multimap_no_prop_move)*/
        )
        ((default_generator)(generate_collisions))
