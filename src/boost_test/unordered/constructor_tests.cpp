...
static test::seed_t initialize_seed(356730);
...
UNORDERED_TEST(constructor_tests1,
    (/*(test_map_std_alloc)*/(test_set)/*(test_multiset)(test_map)*/(test_flat_map)/*(test_multimap)*/)
    ((default_generator)(generate_collisions))
)

UNORDERED_TEST(constructor_tests2,
    (/*(test_multiset)*/(test_set)/*(test_map)*/(test_flat_map)/*(test_multimap)*/)
    ((default_generator)(generate_collisions))
)

UNORDERED_TEST(map_constructor_test,
    ((test_flat_map_std_alloc)/*(test_map)*/(test_flat_map)/*(test_multimap)*/)
    ((default_generator)(generate_collisions))
)
...
UNORDERED_AUTO_TEST(test_default_initializer_list) {
    ...
    boost_test_hash_set<int> x1 = init;
    BOOST_TEST(x1.empty());
}
...
UNORDERED_AUTO_TEST(test_initializer_list) {
    std::cerr<<"Initializer List Tests\n";
    boost_test_hash_set<int> x1 = { 2, 10, 45, -5 };
