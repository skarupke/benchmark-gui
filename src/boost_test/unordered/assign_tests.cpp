...
boost_test_hash_map1<test::object, test::object,
	test::hash, test::equal_to,
    test::allocator2<test::object> >* test_flat_map;
...
UNORDERED_TEST(assign_tests1, (
        ...
        /*(test_map)*/(test_flat_map)
        /*(test_map_prop_assign)*/(test_flat_map_prop_assign)
        /*(test_map_no_prop_assign)*/(test_flat_map_no_prop_assign)
    )
...
UNORDERED_AUTO_TEST(fat_assign_default_initializer_list) {
	std::cerr<<"Initializer List Tests\n";
    std::initializer_list<typename boost_test_hash_map1<int, int>::value_type> init;
    boost_test_hash_map1<int, int> x1;
	x1[25] = 3;
	x1[16] = 10;
	BOOST_TEST(!x1.empty());
	x1 = init;
