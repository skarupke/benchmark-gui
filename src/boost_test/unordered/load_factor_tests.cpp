...
static test::seed_t initialize_seed(783656);
...
void set_load_factor_tests(X*)
{
    ...
    // reasonable.
	x.max_load_factor(1.0); BOOST_TEST(x.max_load_factor() == 1.0);
...
boost_test_hash_map1<int, int>* int_map_ptr;
boost_test_hash_map2<int, int>* int_flat_map_ptr;
...
UNORDERED_TEST(set_load_factor_tests,
    ((int_set_ptr)/*(int_multiset_ptr)*/(int_map_ptr)(int_flat_map_ptr)/*(int_multimap_ptr)*/)
)
