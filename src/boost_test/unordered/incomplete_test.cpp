...
namespace incomplete_test
{
    ...
    typedef boost_test_hash_map1<value, value, hash, equals,
        allocator<std::pair<value const, value> > > flat_map;
	typedef boost::unordered_multimap<value, value, hash, equals,
        allocator<std::pair<value const, value> > > multimap;
    typedef boost_test_hash_set<value, hash, equals,
        allocator<value> > set;
	...
	struct fstruct1 {
        boost_test_hash_map1<fstruct1, fstruct1, hash, equals,
    ...
    struct struct3 {
        boost_test_hash_set<struct3, hash, equals,
            allocator<struct3> > x;
    };
    struct struct4 {
...
TEST(boost_tests, incomplete_test)
{
