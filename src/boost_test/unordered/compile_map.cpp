...
template class BOOST_TEST_HASH_MAP1<
    int,
    int,
    boost::hash<int>,
    std::equal_to<int>,
...
template class BOOST_TEST_HASH_MAP1<
    ...
    test::minimal::default_assignable,
    test::minimal::hash<test::minimal::default_assignable>,
    test::minimal::equal_to<test::minimal::default_assignable>,
    test::minimal::allocator<test::minimal::default_assignable> >;
template class boost::unordered_multimap<
...
UNORDERED_AUTO_TEST(test0)
{
    ...
    typedef std::pair<test::minimal::assignable,
            test::minimal::assignable> value_type;
    value_type value(x, x);

    std::cout<<"Test unordered_map.\n";

    boost_test_hash_map1<int, int> int_map;

    boost_test_hash_map1<int, int,
        boost::hash<int>, std::equal_to<int>,
        test::minimal::cxx11_allocator<std::pair<int const, int> >
        > int_map2;

    boost_test_hash_map1<
        test::minimal::assignable,
        test::minimal::assignable,
        test::minimal::hash<test::minimal::assignable>,
        test::minimal::equal_to<test::minimal::assignable>,
    ...
    container_test(int_map, std::pair<int, int>(0, 0));
    container_test(int_map2, std::pair<int, int>(0, 0));
...
UNORDERED_AUTO_TEST(equality_tests) {
    ...
    boost_test_hash_map1<
        test::minimal::assignable_comparable,
        test::minimal::assignable_comparable,
        test::minimal::hash<test::minimal::assignable_comparable>,
        test::minimal::equal_to<test::minimal::assignable_comparable>,
        test::minimal::allocator<value_type> > map;
...
UNORDERED_AUTO_TEST(test1) {
    ...
    boost_test_hash_map1<int, int> map;
    ...
    unordered_copyable_test(map, value, map_value, std_hash, equal_to);
