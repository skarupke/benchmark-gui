...
typedef boost_test_hash_map1<
	test::exception::object,
    test::exception::object,
	test::exception::hash,
	test::exception::equal_to,
    test::exception::allocator2<test::exception::object> > test_flat_map;
...
#define CONTAINER_SEQ (test_set)/*(test_multiset)(test_map)*/(test_flat_map)/*(test_multimap)*/
