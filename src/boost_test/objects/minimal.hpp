...
namespace minimal
{
    ...
    class assignable_comparable
    {
    public:
        assignable_comparable(constructor_param const&) {}

        assignable_comparable(
            assignable_comparable const&)
        {
        }
        ...
        assignable_comparable& operator=(
            assignable_comparable const&)
        {
            return *this;
        }
    ...
    public:
        ...
        friend ptrdiff_t operator-(ptr l, ptr r)
        {
            return l.ptr_ - r.ptr_;
        }
        friend ptr operator-(ptr l, ptrdiff_t r)
        {
            return ptr(l.ptr_ - r);
        }
    ...
    public:
        ...
        friend const_ptr operator+(std::ptrdiff_t s, const_ptr p)
            { return ptr<T>(s + p.ptr_); }
        friend ptrdiff_t operator-(const_ptr l, const_ptr r)
        {
            return l.ptr_ - r.ptr_;
        }
        friend const_ptr operator-(const_ptr l, ptrdiff_t r)
        {
            return const_ptr(l.ptr_ - r);
        }
